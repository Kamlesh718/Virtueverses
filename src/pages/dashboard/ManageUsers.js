  ...
  return (
    <div className="p-6  rounded-md  ">
      <h1 className="text-xl sm:text-2xl  font-bold text-violet-200 mb-4 sticky">
        {editMode ? "Edit Users" : "Manage Users"}
      </h1>
      {editMode || (
            ...
            <li key={post.id} className="mb-4">
              <div className="bg-violet-400 p-4 rounded-md flex justify-between">
                ...
                <div className="flex gap-2 ">
                  ...
                  <button className="px-3 sm:px-5 py-2 bg-red-600 text-white rounded-md hover:bg-red-500 focus:outline-none focus:ring focus:border-blue-300">
                    Delete
                  </button>
                </div>
              </div>
